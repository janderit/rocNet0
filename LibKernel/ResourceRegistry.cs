...
namespace LibKernel
{
    public interface ResourceRegistry
    {
        ...
        void RegisterResourceHandler(Guid routeGroupId, string nri, int energy, Func<Request, ResourceRepresentation> handler);
        void RegisterResourceHandlerRegex(Guid routeGroupId, string nriRegEx, int energy, Func<Request, ResourceRepresentation> handler);
